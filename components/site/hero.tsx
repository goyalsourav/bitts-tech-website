...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="mx-auto grid min-h-[calc(100svh-5rem)] w-full max-w-[1500px] grid-cols-1 items-center gap-10 px-[5%] pb-16 md:grid-cols-2 lg:gap-14">
        <motion.div
...
function TrustedFlow() {
  ...
  return (
    <div className="relative z-10 mx-auto w-full max-w-[1500px] px-[5%] pb-14">
